          ...
          <AnimateOnScroll animation="slide-right">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="goldOutline" size="xl" asChild>
                <a href="tel:022862021313">Jetzt anrufen</a>
              </Button>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="slide-left">
            <div className="relative">
              <div className="aspect-square lg:aspect-[4/5] rounded-sm overflow-hidden border border-border">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20209.68754756632!2d7.010845174316411!3d50.716025599999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47bee3e45ac24091%3A0xeaa80ffafad917be!2sDuisdorfer%20Barbershop!5e0!3m2!1sde!2sde!4v1771947226076!5m2!1sde!2sde" width="100%" height="100%" style={{ border: 0, filter: 'grayscale(100%) contrast(1.2)' }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Standort Top Salon – Nürnberg" />
              </div>
